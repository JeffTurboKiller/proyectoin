...
pre, form, fieldset, input, textarea, p, blockquote, th, td { 
  ...
  background-size: 100% 100%;
 	background-image: url('C:\Users\equipo\Documentos\spring-workspace\proyectoin\proyectoin\src\main\resources\static\image.jpg');
 	background-color: 
...
<div class="testbox">
	...
	<form:form name = "" method = "post" modelAttribute="ModeloArticulo">
		...
		ID: <form:input type = "number" path = "cod_Modelo" readonly="true"/> <br> 
