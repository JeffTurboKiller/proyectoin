  ...
  <div class='window'>
    ...
    <div class='content'>
      ...
      <div class='input-fields'>
        ...
        <form:input path="celular" type='number' placeholder='celular' class='input-line full-width' maxlength="9"></form:input>
        <form:input path="email" type='email' placeholder='email' class='input-line full-width'></form:input>
        <form:input path="dni" type="number"  placeholder='dni' class='input-line full-width' maxlength="8"></form:input>
      ...
      <div class='spacing'>Ya estas registrado? <span class='highlight' onclick="location.href='<c:url value='/principal'/>'">inicia sesion </span></div>
      <div><button class='ghost-round full-width'>Registrarse</button></div>
    </div>
  </div>
</div>
</section>
