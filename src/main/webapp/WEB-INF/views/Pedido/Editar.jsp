...
<div class='container' style="display: -webkit-box;
  ...
  <div class='window' style="  
    ...
    -ms-flex-flow: column;
    flex-flow: column;
    box-shadow: 0px 15px 50px 10px rgb(0 0 0 / 20%);
   ...
   ID:
  <form:input path="cod_pedido" id="nombres" readonly="true" class='input-line full-width'/><br>   
  Fecha:
  <form:input  path="fecha" id="nombres"  required="true" class='input-line full-width' readonly="true" /><br>
  COD CLIENTE
  <form:input  path="cliente.cod_Cliente" id="nombres"  required="true" class='input-line full-width' readonly="true" /><br>
 ESTADO:
 <form:select path="estadopedido.cod_estado"><br>
 		
 		 <form:options items="${bEstado}" itemValue="cod_estado" itemLabel="estado"  /> <br>
