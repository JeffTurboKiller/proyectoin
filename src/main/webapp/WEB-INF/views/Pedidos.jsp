...
<div  class="container" >
    ...
    <table id="table" style="/* padding: 0%; */position: absolute;/* left: -227px; */right: 0px;left: -400px;top: 27px;">
      <thead>
        <tr>
		<td><b>Pedido</b></td>
		<td><b>Fecha</b></td>
      ...
      <tbody>
		...
		<tr >
					...
					<a onclick="verdetalle(document.getElementById('codigo${pedidos.cod_pedido}'))"> Ver detalle </a>	
